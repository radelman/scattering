...
% striking an oblate spheroid with Robin boundary conditions.
%
% Arguments:
%     k - the wavenumber
...
%
function [v_scat, grad_scat_cart, max_abs_change_scat] = obl_point_source_scat_robin(k, a, eta0, xi0, path, xi1, alpha, x, y, z)
	[ ...
	v_scat, grad_scat_cart, max_abs_change_scat ...
	] = obl_calculate_sum(k, a, path, x, y, z, @(k, a, c, m, n, everything, eta, xi, phi)(calculate_point_source_scat_term(k, a, c, m, n, everything, eta, xi, phi, eta0, xi0, xi1, alpha)));
end
