%
% Calculate the scattered field from a plane wave striking a sound-hard prolate
% spheroid.
%
% Arguments:
%     k - the wavenumber
...
%
function [v_scat, grad_scat_cart, max_abs_change_scat] = pro_plane_wave_scat_hard(k, a, theta0, path, xi1, x, y, z)
	[ ...
	v_scat, grad_scat_cart, max_abs_change_scat ...
	] = pro_calculate_sum(k, a, path, x, y, z, @(k, a, c, m, n, everything, eta, xi, phi)(calculate_plane_wave_scat_term(k, a, c, m, n, everything, eta, xi, phi, theta0, xi1, 'hard')));
end
